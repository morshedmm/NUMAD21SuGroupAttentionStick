...
//                String [] stickerIdList = getStringList(String.valueOf(dataSnapshot.child
//                ("users").child("user1" + addition).child("score").getValue()));
//                String [] userList = getStringList(String.valueOf(dataSnapshot.child("users")
//                .child("user1" + addition).child("senders").getValue()));
